...
<div>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        {{ __('Terimakasih telah mendaftar! Sebelum mulai menggunakan, verifikasi email Anda dengan mengklik link yang telah kami kirimkan melalui email Admin. Jika Anda tidak menerima email verifikasi, klik tombol kirim ulang dibawah ini.') }}
    </div>

    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 font-medium text-sm text-green-600 dark:text-green-400">
            {{ __('Email verifikasi telah dikirim ke email Admin.') }}
        </div>
    @endif
